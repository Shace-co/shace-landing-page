  ...
  <footer class="w-full max-w-[1320px] mx-auto px-5 flex flex-col md:flex-row justify-between items-start gap-8 md:gap-0 py-10 md:py-[70px]">
    <div class="flex flex-col justify-start items-start gap-8 p-4 md:p-8">
      ...
      <div class="flex justify-start items-start gap-3">
        ...
        <a href="#" aria-label="GitHub" class="w-4 h-4 flex items-center justify-center">
          <svg class="w-full h-full text-muted-foreground" fill="currentColor" viewBox="0 0 24 24">
        ...
        <a href="#" aria-label="LinkedIn" class="w-4 h-4 flex items-center justify-center">
          <svg class="w-full h-full text-muted-foreground" fill="currentColor" viewBox="0 0 24 24">
